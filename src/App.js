        ...
        {tab === "calendar" && (
          <div style={{ display:"flex", flexDirection:"column", paddingBottom:65 }}>
            ...
            <div style={{ display:"flex", background:"#13151F", borderRadius:12, padding:4, margin:"12px 18px 4px", border:"1px solid #1C1F2E" }}>
              <button onClick={() => setCalendarInnerTab("time")} style={{ flex:1, padding:"9px", borderRadius:9, border:"none", background: calendarInnerTab==="time"?"#1E3A5F":"transparent", color: calendarInnerTab==="time"?"#60A5FA":"#4B5563", fontSize:13, fontWeight:700, cursor:"pointer", transition:"all 0.15s" }}>⏱ 勉強時間</button>
              <button onClick={() => setCalendarInnerTab("task")} style={{ flex:1, padding:"9px", borderRadius:9, border:"none", background: calendarInnerTab==="task"?"#1E3A5F":"transparent", color: calendarInnerTab==="task"?"#60A5FA":"#4B5563", fontSize:13, fontWeight:700, cursor:"pointer", transition:"all 0.15s" }}>📋 タスク</button>
            </div>
