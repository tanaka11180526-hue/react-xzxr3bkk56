  ...
  return (
    <div style={{ width:"100%", background:"#0D0F16", height:"100vh", display:"flex", flexDirection:"column", fontFamily:"'M PLUS Rounded 1c','Noto Sans JP','Hiragino Sans',sans-serif", overflow:"hidden" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", paddingBottom:65 }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(7,1fr)", padding:"0 10px", gap:3 }}>
              ...
              {Array.from({ length: daysInMonth }, (_,i) => {
                ...
                return (
                  <div key={day} onClick={() => calendarInnerTab === "highlight" ? setHighlightModal({ dateKey: key }) : openModal(key)} style={{ borderRadius:10, padding:"5px 4px 6px", background: isToday?"#1A2235":"#13151F", border: isToday?"1.5px solid #3B82F6":"1.5px solid transparent", cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", gap:2, minHeight:52, WebkitTapHighlightColor:"transparent" }}>
                    ...
                    {calendarInnerTab === "time" && <>
                      ...
                      {daySecs > 0 && (
                        <div style={{ display:"flex", width:"100%", height:3, borderRadius:2, overflow:"hidden", gap:0.5, marginTop:1 }}>
                    ...
                    {calendarInnerTab === "highlight" && dayHighlights.length > 0 && (
                      <div style={{ display:"flex", flexDirection:"column", gap:1, width:"100%" }}>
                        {dayHighlights.map(h => (
                          <div key={h.id} style={{ fontSize:8, fontWeight:800, color:h.color, lineHeight:1.3, textAlign:"center", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap", width:"100%" }}>{h.text}</div>
                        ))}
                      </div>
                    )}
                  </div>
      ...
      {highlightModal && (() => {
        ...
        const HIGHLIGHT_COLORS = ["#F87171","#FB923C","#FBBF24","#4ADE80","#34D399","#60A5FA","#818CF8","#C084FC","#F472B6","#FFFFFF"];
        return (
            ...
            <div style={{ width:"100%", maxWidth:430, margin:"0 auto", background:"#13151F", borderRadius:"20px 20px 0 0", padding:"20px 20px env(safe-area-inset-bottom,24px)", maxHeight:"88vh", overflowY:"auto" }} onClick={e => e.stopPropagation()}>
              ...
              <div style={{ display:"flex", gap:10, marginBottom:18, flexWrap:"wrap" }}>
                {HIGHLIGHT_COLORS.map(c => (
                  <button key={c} onClick={() => setHighlightForm(f => ({ ...f, color: c }))} style={{ width:32, height:32, borderRadius:"50%", background:c, border: highlightForm.color===c?"3px solid #fff":"3px solid transparent", cursor:"pointer", flexShrink:0 }} />
                ))}
              </div>
              {/* プレビュー */}
              {highlightForm.text && (
