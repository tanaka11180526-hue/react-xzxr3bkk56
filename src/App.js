              ...
              <div style={{ padding:"14px 18px 10px", borderBottom:"1px solid #1C1F2E" }}>
                ...
                <div style={{ textAlign:"center", marginBottom:8 }}>
                  ...
                  {isToday && activeSubject && timerStart ? (
                    ...
                    <>
                      <div style={{ fontSize:11, letterSpacing:2, color:"#FBBF24", textTransform:"uppercase", marginBottom:4, fontWeight:700 }}>一時停止中</div>
                      ...
                      <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:5, marginTop:6 }}>
                        <span style={{ fontSize:12, color:"#FBBF24", fontWeight:700 }}>{getSub(pausedSubject).label}</span>
                      ...
                      <div key={hour} style={{ display:"flex", alignItems:"center", marginBottom:3 }}>
                        ...
                        <div style={{ display:"flex", gap:2, flex:1 }}>
                          {rowBlocks.map(({ color, log, isBreak }, i) => {
                            const base = new Date(timerDate+"T00:00:00").getTime();
                            const blockStart = base + hour*3600000 + i*300000;
                            const blockH = String(Math.floor(blockStart / 3600000 % 24)).padStart(2,"0");
                            const blockM = String(Math.floor((blockStart % 3600000) / 60000)).padStart(2,"0");
                            return (
                              <div key={i}
                                onClick={() => {
                                  if (log) { setLogDetailModal({ log }); }
                                ...
                                style={{ flex:1, height:24, borderRadius:4, background: isBreak?"#374151":color||(isCurrentHour?"#1A2035":hasAny?"#1C1F2E":"#13151F"), border: (color||isBreak)?"none":"1px solid "+(isCurrentHour?"#1E3050":"#1A1D27"), cursor: (color||(!isBreak&&isToday))?"pointer":"default", opacity: isBreak?0.6:1 }}
                              />
                            );
                          })}
                        </div>
