        ...
        <div onClick={closeSplash} style={{ position:"fixed", inset:0, zIndex:100, display:"flex", alignItems:"center", justifyContent:"center", padding:32, background:"#0D0F16", transition:"opacity 0.4s", opacity: splashFading?0:1, cursor:"pointer" }}>
          <div style={{ textAlign:"center", maxWidth:320 }}>
            ...
            <div style={{ position:"relative", width:80, height:80, margin:"0 auto 32px" }}>
              {/* 外側の点線円 */}
              <svg width="80" height="80" viewBox="0 0 80 80" style={{ position:"absolute", inset:0, animation:"spinLoader 1.4s linear infinite" }}>
                <circle cx="40" cy="40" r="34" fill="none" stroke="#3B82F6" strokeWidth="2.5" strokeDasharray="8 6" strokeLinecap="round" opacity="0.9"/>
              </svg>
              {/* 内側の細い円（逆回転） */}
              <svg width="80" height="80" viewBox="0 0 80 80" style={{ position:"absolute", inset:0, animation:"spinLoaderRev 2s linear infinite" }}>
                <circle cx="40" cy="40" r="26" fill="none" stroke="#60A5FA" strokeWidth="1.5" strokeDasharray="4 8" strokeLinecap="round" opacity="0.5"/>
              </svg>
              {/* 中央アイコン */}
          ...
          <style>{`
            ...
            @keyframes spinLoaderRev { from { transform: rotate(0deg); } to { transform: rotate(-360deg); } }
          `}</style>
        </div>
      )}
