            ...
            return (
              <div key={g.key} style={{ marginBottom:8 }}>
                ...
                <div style={{
                  ...
                  {g.items.map((r, i) => (
                    <div key={i} onClick={() => onTap(r)} style={{ padding:"12px 14px", borderTop: i>0?"1px solid #1C1F2E":"none", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"space-between", WebkitTapHighlightColor:"transparent" }}>
                      <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                        <div style={{ width:6, height:6, borderRadius:"50%", background:sub.color, flexShrink:0 }} />
                        <span style={{ fontSize:13, color:"#9CA3AF", fontWeight:600 }}>{r.intervalLabel}</span>
